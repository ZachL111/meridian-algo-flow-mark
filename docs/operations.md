...
`meridian-algo-flow-mark` is centered on algorithms work in OCaml. The technical target is: Package an OCaml local lab for flow analysis with bounded scenario files, conflict explanations, and documented operating limits.
