"""Regression checks for the meridian-algo-flow-mark casebook."""
...
from casebook.harness import assert_expected, meridian_algo_flow_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_algo_flow_mark_summary(), assert_expected())
